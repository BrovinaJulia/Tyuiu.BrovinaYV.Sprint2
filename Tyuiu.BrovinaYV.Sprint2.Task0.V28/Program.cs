...
using Tyuiu.BrovinaYV.Sprint2.Task0.V28.Lib;

namespace Tyuiu.BrovinaYV.Sprint2.Task0.V28
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* последовательность(массив):(False, False, False, False, False, False)   *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
